...
import { ProjectsManager } from '@entities/project';
                        ...
                        <div className="dashboard-card" style={{flexGrow: 1, height: "6rem"}}>
                            ...
                            >
                                ...
                                <div onClick={e => clickedColorize(e)}>
                                    <span
                                        className={colorize ? "material-icons-round selected" : "material-icons-round"}>format_color_fill</span>
                                </div>
                                <div
                                    style={{
                                        display: "flex",
                                ...
                                >
                                    ...
                                    <span className="material-icons-round"
                                          onClick={(event) => clickedTodoAdd(event)}>add</span>
                                </div>
                            </div>
                            <div className="todo-card-container">
                                {todoList.map((todo: ToDo, index: number) => {
                                    return (
                                        <div className="todo-item" key={index} onClick={(e) => clickedTodo(e, todo)}>
                                            <div
                                                style={{
                                                    display: "flex",
                                                    justifyContent: "space-between",
